<html>
	...
	<body>
	<h1>Sign up for CCI ECV mailing list</h1>
		<div id="signUpFormErrorMsg"></div>
		<div class="content"><p>Please sign up to receive&nbsp;the latest news and notifications from the CCI ECV projects that interest you</p>
...
<div><div class="webform-component webform-component-textfield" id="webform-component-name"><div class="form-item" id="edit-submitted-name-wrapper">
 ...
 <label>Which CCI ECVs are you interested in? (Select one or more):  
