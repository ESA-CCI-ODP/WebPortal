<html>
	<head>
		...
		<script>
			...
			// Set up our request
			XHR.open('POST', 'http://'+window.location.hostname+'/content/sign-ecv-mailing-list');
...
<form action="/content/sign-ecv-mailing-list" accept-charset="UTF-8" method="post" id="webform-client-form-153" class="webform-client-form" enctype="multipart/form-data" onsubmit="return validateSignUpForm(this)">
<div><div class="webform-component webform-component-textfield" id="webform-component-name"><div class="form-item" id="edit-submitted-name-wrapper">
 ...
 <div class="form-checkboxes"><div class="form-item" id="edit-submitted-mail-list-1-wrapper">
...
<div class="form-item" id="edit-submitted-mail-list-2-wrapper">
 <label class="option" for="edit-submitted-mail-list-2"><input type="checkbox" name="submitted[mail_list][antarctica]" id="edit-submitted-mail-list-2" value="antarctica" class="form-checkbox"> Antarctica Ice Sheets</label>
</div>
...
<div class="form-item" id="edit-submitted-mail-list-6-wrapper">
 <label class="option" for="edit-submitted-mail-list-6"><input type="checkbox" name="submitted[mail_list][glaciers]" id="edit-submitted-mail-list-6" value="glaciers" class="form-checkbox"> Glaciers</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-7-wrapper">
 <label class="option" for="edit-submitted-mail-list-7"><input type="checkbox" name="submitted[mail_list][greenland-is]" id="edit-submitted-mail-list-7" value="greenland-is" class="form-checkbox"> Greenland Ice Sheets</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-8-wrapper">
 <label class="option" for="edit-submitted-mail-list-8"><input type="checkbox" name="submitted[mail_list][ghg]" id="edit-submitted-mail-list-8" value="ghg" class="form-checkbox"> Greenhouse Gases (GHG)</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-9-wrapper">
 <label class="option" for="edit-submitted-mail-list-9"><input type="checkbox" name="submitted[mail_list][land cover]" id="edit-submitted-mail-list-9" value="land cover" class="form-checkbox"> Land Cover</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-10-wrapper">
 <label class="option" for="edit-submitted-mail-list-10"><input type="checkbox" name="submitted[mail_list][ocean colour]" id="edit-submitted-mail-list-10" value="ocean colour" class="form-checkbox"> Ocean Colour</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-11-wrapper">
 <label class="option" for="edit-submitted-mail-list-11"><input type="checkbox" name="submitted[mail_list][ozone]" id="edit-submitted-mail-list-11" value="ozone" class="form-checkbox"> Ozone</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-12-wrapper">
 <label class="option" for="edit-submitted-mail-list-12"><input type="checkbox" name="submitted[mail_list][sea level]" id="edit-submitted-mail-list-12" value="sea level" class="form-checkbox"> Sea Level</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-13-wrapper">
 <label class="option" for="edit-submitted-mail-list-13"><input type="checkbox" name="submitted[mail_list][sst]" id="edit-submitted-mail-list-13" value="sst" class="form-checkbox"> Sea Surface Temperature (SST)</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-14-wrapper">
 <label class="option" for="edit-submitted-mail-list-14"><input type="checkbox" name="submitted[mail_list][sea ice]" id="edit-submitted-mail-list-14" value="sea ice" class="form-checkbox"> Sea Ice</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-15-wrapper">
 <label class="option" for="edit-submitted-mail-list-15"><input type="checkbox" name="submitted[mail_list][soil]" id="edit-submitted-mail-list-15" value="soil" class="form-checkbox"> Soil Moisture</label>
</div>
<div class="form-item" id="edit-submitted-mail-list-16-wrapper">
 <label class="option" for="edit-submitted-mail-list-16"><input type="checkbox" name="submitted[mail_list][toolbox]" id="edit-submitted-mail-list-16" value="toolbox" class="form-checkbox"> Toolbox</label>
</div>
</div>
</div>
